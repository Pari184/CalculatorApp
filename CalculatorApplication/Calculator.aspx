    ...
    <form id="form1" runat="server">
        <div class="container-fluid mt-100">
            <div class="form-group">
                <label class="col-sm-3 col-form-label" for="number1">Number 1:</label>
                <asp:TextBox runat="server" ID="txtNum1"></asp:TextBox>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-form-label" for="number2">Number 2:</label>
                <asp:TextBox runat="server" ID="txtNum2"></asp:TextBox>
            </div>
            <div class="form-group">
                <label class="col-sm-3 col-form-label" for="result">Result:</label>
